        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscrowBalance = table.Column<double>(type: "numeric", nullable: true),
                    ...
                    CurrentMonthDeposits = table.Column<double>(type: "numeric", nullable: false),
                    CurrentMonthWithdrawals = table.Column<double>(type: "numeric", nullable: false),
                    PreviousMonthDeposits = table.Column<double>(type: "numeric", nullable: false),
                    PreviousMonthWithdrawals = table.Column<double>(type: "numeric", nullable: false),
                    CurrentYearDeposits = table.Column<double>(type: "numeric", nullable: false),
                    CurrentYearWithdrawals = table.Column<double>(type: "numeric", nullable: false),
                    PreviousYearDeposits = table.Column<double>(type: "numeric", nullable: false),
                    PreviousYearWithdrawals = table.Column<double>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyAmount = table.Column<double>(type: "numeric", nullable: false),
                    CurrentMonthAmount = table.Column<double>(type: "numeric", nullable: false),
                    PreviousMonthAmount = table.Column<double>(type: "numeric", nullable: false),
                    CurrentYearAmount = table.Column<double>(type: "numeric", nullable: false),
                    PreviousYearAmount = table.Column<double>(type: "numeric", nullable: false),
                    EscrowBalance = table.Column<double>(type: "numeric", nullable: true),
                    Notes = table.Column<string>(type: "text(1073741823)", nullable: true)
                },
                constraints: table =>
